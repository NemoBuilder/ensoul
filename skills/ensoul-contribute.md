...
- `confidence`: Curator AI confidence score (0–1)
- `reject_reason`: Why it was rejected (only present when `status` is `rejected`)

### Dashboard Overview

Get a high-level summary of your stats:
