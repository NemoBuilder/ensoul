...
import type { VibeWriteReply, ReplyVariant, SubscriptionStatus } from "@/lib/api";

interface VibeWritePanelProps {
  reply: VibeWriteReply | null;
  loading: boolean;
  error: string | null;
...
export default function VibeWritePanel({
  reply,
  loading,
  error,
  subscription,
